...
import { Form, Input, Modal,DatePicker,Select,InputNumber,message } from 'antd'
  ...
  return (
    <Modal {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label="客户地址" hasFeedback {...formItemLayout}>
        ...
        <FormItem label="物流地址" hasFeedback {...formItemLayout}>
