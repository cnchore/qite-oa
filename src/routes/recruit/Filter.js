...
const Filter = ({
  ...
  const { codeLike, createTime,postNameLike } = filter
  ...
  return (
    <Row gutter={24}>
      ...
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }} >
        {getFieldDecorator('postNameLike', 
          { initialValue: postNameLike 
          })(<Search placeholder="岗位名称" size="large" onSearch={handleSubmit} />)}
      </Col>
