  ...
  const columns = [
    {
      ...
      title: '原岗位',width:120,
      key: 'originalPost',
      dataIndex:'originalPost',
    }, {
      title: '当前部门',
      dataIndex: 'curDept',width:120,
      key: 'curDept',
    }, {
      title: '当前岗位',width:120,
      dataIndex: 'curPost',
      key: 'curPost',
    }, {
      title: '状态',
      ...
      fixed:'right',
      width: 250,
      render: (text, record)=>getRecordAction('salaryChange',record,onEditItem,handleSubmit,handleDel,onChange,true),
    },
  ]
