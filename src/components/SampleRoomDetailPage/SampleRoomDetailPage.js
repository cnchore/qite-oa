...
import styles from './SampleRoomDetailPage.less'
import { Icon,Row,Col,Table,Tooltip } from 'antd'
import classNames from 'classnames';
import FileList from '../FileList'
import {changeMoneyToChinese} from '../../utils'
class SampleRoomDetailPage extends React.Component {
  render () {
...
SampleRoomDetailPage.propTypes = {
}
export default SampleRoomDetailPage
