...
import styles from './MaterialSupportDetailPage.less'
import { Icon,Row,Col,Table,Tooltip } from 'antd'
import classNames from 'classnames';
import FileList from '../FileList'
import {changeMoneyToChinese} from '../../utils'
class MaterialSupportDetailPage extends React.Component {
  render () {
      ...
      <div>
        <Row gutter={24} className={styles['q-detail']}>
          <Col span={24} className='qite-list-title'>
              <Icon type="credit-card" />物料支持自助申请信息
          </Col>
...
MaterialSupportDetailPage.propTypes = {
}
export default MaterialSupportDetailPage
