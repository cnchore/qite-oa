import { query,queryById,save,deleteById,submit,queryEmployee,getDic } from '../services/salaryChange'
...
export default {
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen(location => {
        ...
        if (location.pathname === '/salaryChange') {
  ...
  effects: {
    ...
    *update ({ payload }, { select, call, put }) {
      const id = yield select(({ salaryChange }) => salaryChange.currentItem.id)
