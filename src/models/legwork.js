import { query,queryById,save,deleteById,submit,queryEmployee,getDic } from '../services/legwork'
...
export default {
  ...
  effects: {
    *query ({ payload }, { call, put }) {
      ...
      let _payload=parse(location.hash.split('#/legwork?')[1]); 
    ...
    *update ({ payload }, { select, call, put }) {
      const id = yield select(({ legwork }) => legwork.currentItem.id)
