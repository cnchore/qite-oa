import { query,queryById,save,deleteById,submit,queryEmployee,getDic } from '../services/recruit'
...
export default {
  ...
  effects: {
    *query ({ payload }, { call, put }) {
      ...
      let _payload=parse(location.hash.split('#/recruit?')[1]); 
    ...
    *update ({ payload }, { select, call, put }) {
      const id = yield select(({ recruit }) => recruit.currentItem.id)
