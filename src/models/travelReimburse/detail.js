...
import { queryById,queryEmployee,getDic } from '../../services/travelReimburse'
//import { treeToArray } from '../../utils'
import { getDiagramByBusiness,getCommentListBybusiness } from '../../services/workFlow'

export default {

  namespace: 'travelReimburseDetail',
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen(() => {
        const match = pathToRegexp('/travelReimburse/:id').exec(location.pathname)
        if (match) {
