import { query,create, remove, update } from '../services/organization'
...
export default {
  ...
  reducers: {
    ...
    onSwitch (state) {
      let _expandedRowKeys=state.isSwitch?[]:state.list.map((item)=>item.id);
      return { ...state, expandedRowKeys: _expandedRowKeys,isSwitch:!state.isSwitch }
    },
